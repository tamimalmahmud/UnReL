...
def main(cfg):
    ...
    training_args = transformers.TrainingArguments(
            ...
            # deepspeed='config/ds_config.json',  # Commented out DeepSpeed
            weight_decay = cfg.weight_decay,
            seed = cfg.seed,
        )

    model = AutoModelForCausalLM.from_pretrained(model_id, use_flash_attention_2=False, torch_dtype=torch.bfloat16, trust_remote_code=True)
    ...
    # Save the running time to a text file in the save directory
